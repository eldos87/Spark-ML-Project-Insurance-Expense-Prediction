...
class DataTransformer:
    def __init__(self, config, logger):
        try:
            ...
            self.dataset_database = self.config["database_detail"]["training_database_name"]
            self.dataset_collection_name = self.config["database_detail"]["dataset_training_collection_name"]
