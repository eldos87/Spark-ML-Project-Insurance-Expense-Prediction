...
log_collection_name = "model_trainer"
...
class DataPreProcessing:
    ...
    def create_input_features(self, required_column):
        try:
    ...
    def get_train_test_dataframe(self, test_size):
        try:
    ...
    def get_prepared_dataset(self):
        try:
            ...
            create_directory_path(self.pipeline_path)
...
def train_main(config_path):
    try:
        ...
        model_trainer = ModelTrainer(config=config, logger=logger)
